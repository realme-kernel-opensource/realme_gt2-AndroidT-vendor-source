...
int syna_set_input_reporting_s3910(struct syna_tcm_data *tcm_info, bool suspend)
{
	int retval = 0;
	struct touch_hcd *touch_hcd = tcm_info->touch_hcd;
...
static int syna_tcm_set_gesture_mode(struct syna_tcm_data *tcm_info, int enable)
{
	...
	if (enable) {
		...
		retval = syna_set_input_reporting_s3910(tcm_info, true);
...
static int syna_tcm_normal_mode(struct syna_tcm_data *tcm_info)
{
	...
	TPD_INFO("%s : enter\n", __func__);
	retval = syna_set_input_reporting_s3910(tcm_info, false);
...
int __init tp_driver_init_syna_tcm_s3910(void)
{
	TPD_INFO("%s is called\n", __func__);
...
void __exit tp_driver_exit_syna_tcm_s3910(void)
{
	TPD_INFO("%s is called\n", __func__);
...
late_initcall(tp_driver_init_syna_tcm_s3910);
#else
module_init(tp_driver_init_syna_tcm_s3910);
#endif
module_exit(tp_driver_exit_syna_tcm_s3910);
